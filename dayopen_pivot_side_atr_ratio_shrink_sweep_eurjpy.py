...
def main():
    ...
    for i in range(N_SWEEPS):
        ...
        print(
            ...
            f"cal_ppd={r['cal_ppd']:+.4f} wins={r['wins']} losses={r['losses']}"
        )
    ...
    out_json = OUT_DIR / "dayopen_pivot_side_atr_ratio_shrink_sweep_eurjpy_full_days.json"
    out_csv = OUT_DIR / "dayopen_pivot_side_atr_ratio_shrink_sweep_eurjpy_full_days.csv"
